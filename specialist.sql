...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 18 2019 г., 17:56
...
(2, 'SP000000095', 1, 1, '1550566789', '', '1'),
...
(3, 1, 46, 2, 1, 2, 4, 0, '1550487676', '', '1500', 2, '1'),
(4, 3, 51, 1, 1, 3, 5, 0, '', '', '', 0, '1'),
...
(61, '', 'Серия SDA', 20, 0, 4, '', '', '', '1'),
(62, 'SDA-ROD-6', 'Шток', 61, 1, 0, '', '', '', '1'),
(63, 'SDA-ROD-8', 'Шток', 61, 1, 0, '', '', '', '1'),
(64, 'SDA-ROD-10', 'Шток', 51, 1, 4, '1260', '120', '', ''),
...
(70, 'SDA-ROD-10', 'Шток', 51, 1, 4, '1260', '120', '', '1'),
(71, 'SDA-PIPE-25', 'Гильза', 51, 1, 4, '2400', '60', '', '1');
