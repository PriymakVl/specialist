...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 07 2019 г., 17:49
...
(13, 'test order', 3, 1, '1551941944', '', '1'),
(14, 'test 2', 1, 1, '1552546351', '', '1'),
(15, 'wwww', 2, 1, '', '', '1');
...
CREATE TABLE `order_actions` (
  ...
  `id_data` int(11) NOT NULL COMMENT 'id data action',
  `qty` int(5) NOT NULL,
...
(3, 1, 138, 2, 2, 4, 1, '1551703879', '1551963029', '41', 2, '1'),
(4, 1, 138, 4, 2, 4, 1, '1551703665', '1551959753', '11', 2, '1'),
(5, 1, 139, 1, 2, 4, 1, '1551334675', '1551334679', '7', 2, '1'),
(6, 1, 139, 2, 2, 4, 1, '1551960151', '1551960209', '61', 2, '1'),
...
(27, 6, 178, 2, 3, 4, 1, '1551963030', '1551963035', '22', 2, '1'),
...
(54, 5, 175, 4, 1, 2, 1, '1551959259', '', '7', 2, '1'),
...
(94, 11, 197, 3, 8, 4, 1, '1551789194', '1551883646', '21', 2, '1'),
(95, 11, 186, 1, 2, 4, 1, '1551344364', '1551344398', '7', 3, '1'),
(96, 11, 186, 3, 2, 4, 1, '1551883650', '1551883667', '17', 2, '1'),
...
(104, 13, 96, 1, 1, 4, 1, '', '', '3', 0, '1'),
(105, 13, 96, 2, 1, 1, 1, '', '', '11', 0, '1');
...
(1, 6, 'plan', 2, '1551960151', 2, '1'),
(2, 6, 'plan', 3, '1551960179', 2, '1'),
(3, 6, 'plan', 2, '1551960199', 2, '1'),
(4, 6, 'plan', 4, '1551960209', 2, '1'),
(5, 2, 'plan', 2, '1551962114', 1, '1'),
(6, 2, 'plan', 3, '1551962121', 1, '1'),
(7, 2, 'plan', 4, '1551962143', 1, '1'),
(8, 3, 'plan', 4, '1551963029', 2, '1'),
(9, 27, 'plan', 2, '1551963030', 2, '1'),
(10, 27, 'plan', 4, '1551963035', 2, '1');
...
(2, 13, 1, 4, 'SR-PIPE-32', 'Гильза', 'дополнительна', '1551959776', '1551959790', '12', 2, '', '1');
...
(23, 13, 'test product', 1, '', '1'),
(24, 14, 'test positioono', 2, '', '1'),
(25, 14, 'test 3', 2, '', '1'),
(26, 15, 'eee', 1, '', '1'),
(27, 15, 'eee', 1, '', '1');
...
(103, 'SC-TR-H-6', 'Шпилька 6мм', 1, 4, 4, '', '0'),
...
(200, 'SR/SE-ROD-20', 'Шток', 3, 1, 4, '', '1'),
(201, 'SR/SE-ROD-12', 'Шток', 4, 1, 4, '', '1');
...
CREATE TABLE `product_actions` (
  ...
  `id_data` int(10) NOT NULL COMMENT 'id data action',
...
(96, 'SA-CU', 6, 1, '10', '', '', '1'),
(97, 'SC-SR-32', 3, 3, '50', '20', '', '0'),
(98, 'SC-SR-63', 2, 2, '4', '2', '', '0');
