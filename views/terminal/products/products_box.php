...
<div id="terminal-products-wrp">
	<? foreach ($products as $product): ?>
		<div class="terminal-product-box" style="background:<?=$product->bgTerminalProductBox?>" prod_name="<?=$product->name?>" id_order="<?=$order->id?>" id_prod="<?=$product->id?>" id_worker="<?=$worker->id?>" state_work="<?=$product->stateWork?>">
